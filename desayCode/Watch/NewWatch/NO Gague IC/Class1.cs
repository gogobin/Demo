...
namespace DataDisplay
{
       ...
       public   class DataToXml
    {
        ...
        private void DataGridViewToXml(DataGridViewExportOptions dataGridViewExportOption, String filePath)
        {
            DataGridViewToXml(new List<DataGridViewExportOptions>(new DataGridViewExportOptions[] { dataGridViewExportOption }), filePath);
        }
        private void DataGridViewToXml(List<DataGridViewExportOptions> dataGridViewExportOptions, String filePath)
        {
