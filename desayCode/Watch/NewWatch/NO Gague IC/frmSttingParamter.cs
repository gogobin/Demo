...
namespace IC.NOGagueIC.SW
{
    public partial class frmSttingParamter : Form
    {
        ...
        private void ShowDataGridViewCol(string item)
        {
            ...
            HeaderList.Add("0", "");
            HeaderList.Add("1", "Voltage_Min(mV),Voltage_Max(mV),WakeUp_Current(mA),Retry,Delay,Errorcode,LogName");
            HeaderList.Add("2", "HW_Version,Retry,Delay,ErrorCode,LogName");
            HeaderList.Add("3", "Retry,Delay,ErrorCode,LogName");
            HeaderList.Add("4", "Voltage_Min(mV),Voltage_Max(mV),Retry,Delay,Errorcode,LogName");
            HeaderList.Add("5", "Voltage_Min(mV),Voltage_Max(mV),Retry,Delay,Errorcode,LogName");
            HeaderList.Add("6", "Voltage_Min(mV),Voltage_Max(mV),Retry,Delay,Errorcode,LogName");
            HeaderList.Add("7", "Resistance_Min(omh),Reistacne_Max(omh),Retry,Delay,Errorcode,LogName");
            HeaderList.Add("8", "Resistance_Min(omh),Reistacne_Max(omh),Current(mA),Retry,Delay,Errorcode,LogName");
            HeaderList.Add("9", "Current_Step(mA),Current_Min(mA),Current_Max(mA),Retry,Delay,Errorcode,LogName");
            HeaderList.Add("10", "Delay_Min(ms),Delay_Max(ms),Retry,Delay,ErrorCode,LogName");
            HeaderList.Add("11", "Retry,Delay,ErrorCode,LogName");
            HeaderList.Add("12", "Current_Step(mA),Current_Min(mA),Current_Max(mA),Retry,Delay,Errorcode,LogName");
            HeaderList.Add("13", "Delay_Min(ms),Delay_Max(ms),Retry,Delay,ErrorCode,LogName");
            HeaderList.Add("14", "Retry,Delay,ErrorCode,LogName");
            HeaderList.Add("15", "Current_Min(mA),Current_Max(mA),Retry,Delay,Errorcode,LogName");
            HeaderList.Add("16", "Current_set(mA),Current_Min(mA),Current_Max(mA),Current_Min_Acc(mA),Current_Max_Acc(mA),Retry,Delay,ErrorCode,LogName");
            HeaderList.Add("17", "Current_set(mA),Current_Min(mA),Current_Max(mA),Current_Min_Acc(mA),Current_Max_Acc(mA),Retry,Delay,ErrorCode,LogName");
            HeaderList.Add("18", "Current_set(mA),Current_Min(mA),Current_Max(mA),Current_Min_Acc(mA),Current_Max_Acc(mA),Retry,Delay,ErrorCode,LogName");
            HeaderList.Add("19", "Current_set(mA),Current_Min(mA),Current_Max(mA),Current_Min_Acc(mA),Current_Max_Acc(mA),Retry,Delay,ErrorCode,LogName");
            HeaderList.Add("20", "temp_Min(℃),temp_Max(℃),Retry,Delay,ErrorCode,LogName");
            HeaderList.Add("21", "Voltage_Acc_Min(mV),Voltage_Acc_Max(mV),Retry,Delay,ErrorCode,LogName");
            HeaderList.Add("22", "temp_Min(℃),temp_Max(℃),Retry,Delay,ErrorCode,LogName");
            HeaderList.Add("23", "Rsoc_Min(%),Rosc_Max(%),Retry,Delay,ErrorCode,LogName");
            HeaderList.Add("24", "FCC_Min(mAh),FCC_Max(mAh),Retry,Delay,ErrorCode,LogName");
            HeaderList.Add("25", "NCC_Min(mAh),NCC_Max(mAh),Retry,Delay,ErrorCode,LogName");
            HeaderList.Add("26", "Cycle_Count_Min,Cycle_Count_Max,Retry,Delay,ErrorCode,LogName");
            HeaderList.Add("27", "chem_id,Retry,Delay,ErrorCode,LogName");
            HeaderList.Add("28", "chem_dfcs,Retry,Delay,ErrorCode,LogName");
            HeaderList.Add("29", "prot_cs,Retry,Delay,ErrorCode,LogName");
            HeaderList.Add("30", "Start_Register(Hex),Bytes_to_Write(Hex),Retry,Delay,ErrorCode,LogName");
            HeaderList.Add("31", "Qen_Status,Retry,Delay,ErrorCode,LogName");
            HeaderList.Add("32", "Retry,Delay,ErrorCode,LogName");
            HeaderList.Add("33", "Retry,Delay,ErrorCode,LogName");
            HeaderList.Add("34", "Retry,Delay,ErrorCode,LogName");
            HeaderList.Add("35", "Retry,Delay,ErrorCode,LogName");
            HeaderList.Add("36", "Voltage_Min(mV),Voltage_Max(mV),Retry,Delay,Errorcode,LogName");
            HeaderList.Add("37", "Retry,Delay,ErrorCode,LogName");
            HeaderList.Add("38", "static_dfcs,Retry,Delay,ErrorCode,LogName");
            HeaderList.Add("39", "Current_Min(mA),Current_Max(mA),Retry,Delay,Errorcode,LogName");
            HeaderList.Add("40", "FET_Control,Retry,Delay,ErrorCode,LogName");
            HeaderList.Add("41", "Retry,Delay,ErrorCode,LogName");
            HeaderList.Add("42", "Retry,Delay,ErrorCode,LogName");
            HeaderList.Add("43", "Retry,Delay,ErrorCode,LogName");
            HeaderList.Add("44", "Retry,Delay,ErrorCode,LogName");
        ...
        {
            frmParaMter ower = (frmParaMter)this.Owner;
            if (Convert.ToString(ower.dgvTestStep.Rows[0].Cells[0].Value).Trim() != "0" && txtBoxSetpIndex.Text.Trim() != "0")
            {
