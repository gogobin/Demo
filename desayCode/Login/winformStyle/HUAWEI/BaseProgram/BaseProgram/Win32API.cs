...
namespace BaseProgram
{
    ...
    public class CIniFile
    {
        ...
        static public string ReadValue(string Section, string Key, string innpath)
        {
            StringBuilder temp = new StringBuilder(500);
            GetPrivateProfileString(Section, Key, "", temp, 500, innpath);
            return temp.ToString();
        }

        static public void WriteValue(string Section, string Key, string Value, string inipath)
        {
